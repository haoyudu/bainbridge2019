...
#| message: false
#| warning: false
# ggplot(plot_data, aes(x = Condition, y = accuracy)) +
#   geom_point(alpha = 0.6, size = 1.5, 
#              position = position_jitter(width = 0.1, seed = 42)) +
#   stat_summary(fun = mean, geom = "point", size = 3, 
#                aes(color = Condition), show.legend = FALSE) +
#   stat_summary(fun.data = mean_cl_boot, geom = "errorbar", 
#                width = 0.1, size = 1, aes(color = Condition), show.legend = FALSE) +
#   geom_hline(yintercept = 1/3, linetype = "dashed", alpha = 0.7) +
#   annotate("text", x = 2.3, y = 1/3, label = "Chance", vjust = -0.5, size = 3) +
#   scale_y_continuous(limits = c(0, 1), labels = percent_format(),
#                      breaks = seq(0, 1, 0.1)) +
