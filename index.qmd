...
#### Actual Sample
Pilot B included 6 participants recruited via Prolific. No participants were excluded based on the preregistered criteria: all completed 60 trials, passed attention checks, reported no technical difficulties, and showed adequate response times and compliance. All 360 trials were retained after applying the 1200ms RT threshold.
...
Delayed Recall drawings (Median = 0.833) were significantly more recognizable than Category Drawings (Median = 0.333), $W = 29{,}108$, $p = 1.19 \times 10^{-39}$, rank-biserial $r = 0.80$, 95% CI [0.75, 0.84].
...
Both conditions violated normality (Delayed Recall: $W = 0.84$, $p = 3.37 \times 10^{-13}$; Category: $W = 0.91$, $p = 1.27 \times 10^{-8}$) and homogeneity of variance (Levene's $F = 27.74$, $p = 2.40 \times 10^{-7}$). Welch's correction was applied.

Delayed Recall drawings ($M = 0.757$, $SD = 0.261$) were significantly more recognizable than Category Drawings ($M = 0.317$, $SD = 0.144$), $t(290.12) = 19.94$, $p = 2.60 \times 10^{-56}$, Cohen's $d = 2.07$, 95% CI [1.81, 2.33].

The replication criteria were met: significant difference ($p < 0.05$) and large effect size ($r = 0.80 \gg 0.3$ threshold).
